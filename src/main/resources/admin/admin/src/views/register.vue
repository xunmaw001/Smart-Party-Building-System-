  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='dangzhibu'" class="input-group">
			   <div class="label">党支部名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dangzhibumingcheng" class="input" type="text" placeholder="党支部名称">
			   </div>
			 </div> -->
			<el-form-item label="党支部名称" class="input" v-if="tableName=='dangzhibu'">
			  <el-input v-model="ruleForm.dangzhibumingcheng" autocomplete="off" placeholder="党支部名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dangzhibu'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='dangzhibu'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='dangzhibu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='dangzhibu'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='dangzhibu'" class="input-group">
			   <div class="label">党支部地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dangzhibudizhi" class="input" type="text" placeholder="党支部地址">
			   </div>
			 </div> -->
			<el-form-item label="党支部地址" class="input" v-if="tableName=='dangzhibu'">
			  <el-input v-model="ruleForm.dangzhibudizhi" autocomplete="off" placeholder="党支部地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='dangzhibu'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='dangzhibu'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.dangzhibumingcheng) && `dangzhibu` == this.tableName){
        this.$message.error(`党支部名称不能为空`);
        return
      }
      if((!this.ruleForm.fuzeren) && `dangzhibu` == this.tableName){
        this.$message.error(`负责人不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `dangzhibu` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `dangzhibu` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`dangzhibu` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){

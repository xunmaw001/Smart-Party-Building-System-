<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="党费" prop="dangfei">
          <el-input v-model="ruleForm.dangfei" 
              placeholder="党费" clearable  :readonly="ro.dangfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="党费" prop="dangfei">
              <el-input v-model="ruleForm.dangfei" 
                placeholder="党费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dangzhibudizhi = true;
          ...
          if(o=='dangfei'){
            this.ruleForm.dangfei = obj[o];
	    this.ro.dangfei = true;
            continue;
          }
          if(o=='tijiaoriqi'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaonadangfei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaonadangfeiCrossAddOrUpdateFlag = false;
						 this.parent.search();

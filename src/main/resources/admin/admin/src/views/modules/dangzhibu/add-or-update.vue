<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="党支部名称" prop="dangzhibumingcheng">
          <el-input v-model="ruleForm.dangzhibumingcheng" 
              placeholder="党支部名称" clearable  :readonly="ro.dangzhibumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="党支部名称" prop="dangzhibumingcheng">
              <el-input v-model="ruleForm.dangzhibumingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="党支部地址" prop="dangzhibudizhi">
          <el-input v-model="ruleForm.dangzhibudizhi" 
              placeholder="党支部地址" clearable  :readonly="ro.dangzhibudizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="党支部地址" prop="dangzhibudizhi">
              <el-input v-model="ruleForm.dangzhibudizhi" 
                placeholder="党支部地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="党支部详情" prop="dangzhibuxiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="党支部详情"
                  v-model="ruleForm.dangzhibuxiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dangzhibuxiangqing" label="党支部详情" prop="dangzhibuxiangqing">
                    <span>{{ruleForm.dangzhibuxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	mima : false,
	fengmian : false,
	dangzhibuxiangqing : false,
	dangzhibudizhi : false,
	lianxidianhua : false,
      },
      ruleForm: {
        dangzhibumingcheng: '',
      ...
      rules: {
          dangzhibumingcheng: [
                { required: true, message: '党支部名称不能为空', trigger: 'blur' },
          ],
          fuzeren: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='dangzhibuxiangqing'){
            this.ruleForm.dangzhibuxiangqing = obj[o];
	    this.ro.dangzhibuxiangqing = true;
            continue;
          }
          if(o=='dangzhibudizhi'){
            this.ruleForm.dangzhibudizhi = obj[o];
	    this.ro.dangzhibudizhi = true;
            continue;
          }
          if(o=='lianxidianhua'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangzhibu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangzhibuCrossAddOrUpdateFlag = false;
						 this.parent.search();
